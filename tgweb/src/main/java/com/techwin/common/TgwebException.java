...
/**
 * This TgwebException class contains various constructor for different
 * functionality on this project.
 * 
 * @author Sooyeon Park
 */
public class TgwebException extends BaseException {
	 ...
	 */
	public TgwebException(final MessageSource messageSource,
	 ...
	 *            the exception that is wrapped in this exception
	 */
	public TgwebException(final String message, final Throwable exception) {
	 ...
	 *            the message of this exception
	 */
	public TgwebException(final String message) {
		super(message);
	}
}
