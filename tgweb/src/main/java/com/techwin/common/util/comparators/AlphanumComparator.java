 ...
 * 
 * To convert to use Templates (Java 1.5+): - Change "implements Comparator" to "implements Comparator<String>" - Change "compare(Object o1, Object o2)" to
...
public abstract class AlphanumComparator implements Comparator {
	...
	public int compareWithString(Object o1, Object o2) {
