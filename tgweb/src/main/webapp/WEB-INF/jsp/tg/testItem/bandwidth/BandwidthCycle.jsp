...
$(function() {
	$.Topic("dataGrid/xhrComplete/" + "tgBandwidthCycle.do").subscribe(fnGroupHeaders);
	...
	function fnGroupHeaders(data) {
		...
		$.Topic("dataGrid/xhrComplete/" + "tgBandwidthCycle.do").unsubscribe(fnGroupHeaders);
	}
});
</script>
...
<c:if test="${params.CATEGORY == 'DVR'}">
	...
	<div>
		<table id="${_wid}_grid" class="grid" data="{wid:'${_wid}', formId:'${_wid}_searchForm', url:'tgBandwidthCycle.do', postData:{method:'s'}, key:'TC_IDX', caption:'<spring:message code="tgweb.common.BANDWIDTH.title"/> Cycle', pager:'#${_wid}_pager'}">
			<tr>
				<th field="CYCLE" url="tgBandwidthDetail.do" addParam="{'method':'t'}" uid="BandwidthCycle" width="60px">Cycle</th>
				...
				<th field="EXECUTION_TIME" width="160px">Running Time</th>
			</tr>
		</table>
