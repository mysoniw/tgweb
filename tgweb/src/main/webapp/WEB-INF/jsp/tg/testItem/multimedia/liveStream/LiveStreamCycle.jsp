...
var chart;
$(function() {
	$.Topic("dataGrid/xhrComplete/" + "tgLiveStreamCycle.do").subscribe(function sub(data) {
		...
		$.Topic("dataGrid/xhrComplete/" + "tgLiveStreamCycle.do").unsubscribe(sub);
	});
...
<c:if test="${params.CATEGORY == 'DVR'}">
	...
	<div style="float:left;">
		<table id="${_wid}_grid" class="grid" data="{wid:'${_wid}', formId:'${_wid}_searchForm', url:'tgLiveStreamCycle.do', postData:{method:'s'}, key:'TC_IDX', caption:'<spring:message code="tgweb.common.LIVE_STREAM.title"/> Cycle', pager:'#${_wid}_pager'}"
			filterGrid="{'column':'${params.filterColumn}', 'value':'${params.filterValue}', 'len':'${params.FAIL}'}">
			<tr>
				<th field="CYCLE" url="tgLiveStreamDetail.do" addParam="{'method':'t'}" uid="LiveStreamCycle" width="60px">Cycle</th>
