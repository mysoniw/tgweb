...
<form id="${_wid}_searchForm">
	...
	<div>
		<table id="${_wid}_grid" class="grid" data="{wid:'${_wid}', formId:'${_wid}_searchForm', url:'tgOSDTc.do', postData:{method:'s'}, key:'TC_IDX', caption:'<spring:message code="tgweb.common.OSD.title"/> TestCase', pager:'#${_wid}_pager'}"
			...
			<tr>
				...
				<th field="TOTAL_CYCLE" url="tgOSDCycle.do" addParam="{'method':'t', 'tabTitle':'TEST_CASE_ID'}" uid="OSDTc" width="80px;">Total Cycle</th>
				<th field="RESULT" syntax="{'matcher':'NOT_MATCH', 'flag':'PASS','syntaxColor':'red'}" width="80px">Result</th>
				<th field="PASS" width="60px">PASS</th>
				<th field="FAIL" syntax="{'matcher':'NOT_MATCH', 'flag':0, 'syntaxColor':'red'}" url="tgOSDCycle.do" addParam="{'method':'t', 'tabTitle':'TEST_CASE_ID', 'filterColumn':'RESULT', 'filterValue':'FAIL'}" width="60px">FAIL</th>
