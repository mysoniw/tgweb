...
<form id="${_wid}_searchForm">
	...
	<div style="float:left;">
		<table id="${_wid}_grid" class="grid" data="{wid:'${_wid}', formId:'${_wid}_searchForm', url:'tgRs485Cycle.do', postData:{method:'s'}, key:'TC_IDX', caption:'<spring:message code="tgweb.common.RS_485.title"/> Cycle', pager:'#${_wid}_pager'}"
			filterGrid="{'column':'${params.filterColumn}', 'value':'${params.filterValue}', 'len':'${params.FAIL}'}">
			<tr>
				<th field="CYCLE" url="tgRs485Detail.do" addParam="{'method':'t'}" uid="485Cycle" width="60px">Cycle</th>
