...
<form id="${_wid}_searchForm">
	...
	<div style="float:left;">
		<table id="${_wid}_grid" class="grid" data="{wid:'${_wid}', formId:'${_wid}_searchForm', url:'tgWebCycle.do', postData:{method:'s'}, key:'TC_IDX', caption:'<spring:message code="tgweb.common.WEB.title"/> Cycle', pager:'#${_wid}_pager'}"
			filterGrid="{'column':'${params.filterColumn}', 'value':'${params.filterValue}', 'len':'${params.FAIL}'}">
			<tr>
				<th field="CYCLE" url="tgWebDetail.do" addParam="{'method':'t'}" uid="WebCycle" width="60px">Cycle</th>
				<th field="EXTRA1" width="100px">Browser Type</th>
				<th field="EXTRA2" width="120px">Browser Version</th>
				<!-- <th field="RESULT" syntax="{'flag':'FAIL', 'syntaxColor':'red'}" url="tgWebDetail.do" addParam="{'method':'t'}" uid="WebCycle" width="140px">Result</th> -->
				<th field="RESULT" syntax="{'flag':'FAIL', 'syntaxColor':'red'}" width="140px">Result</th>
