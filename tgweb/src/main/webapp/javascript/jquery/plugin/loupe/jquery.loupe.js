/**
 * loupe - an image magnifier for jQuery (C) 2010 jdbartlett, MIT license
...
(function($) {
	$.fn.loupe = function(arg) {
		...
		return this.length ? this.each(function() {
			var $this = $(this), $big, $loupe, $small = $this.is('img') ? $this : $this.find('img:first'), move, hide = function() {
				$loupe.hide();
			}, time;
			...
			move = function(e) {
				...
				if (!$this.data('loupe') || e.pageX > sW + os.left + 10 || e.pageX < os.left - 10 || e.pageY > sH + os.top + 10
						|| e.pageY < os.top - 10) {
					return hide();
				}
